...
$para = "atendimento@climatis.com.br";
$Assunto = "PMOC";
$nome = $_POST['nome'];
$email = $_POST['email'];

//AQUI ENVIO O PRIMEIRO EMAIL PARA O DESTINATARIO
$corpo = "<strong>Dados Contato via Site</strong><br><br>";
...
if (mail($para, $Assunto, $corpo, $headers)) {
  echo "<script>location.href='agradecimento-pmoc.html'</script>";
} else {
  $mgm = "ERRO AO ENVIAR E-MAIL!";
  echo "<meta http-equiv='refresh' content='10;URL=landing-page-pmoc.html'>";
}
